...
2. Clone the plugin
   ``bash   git clone https://github.com/luismayta/zsh-pyenv``\ bash
3. Edit your ``.zshrc`` and add
   ``plugins=( ... zsh-pyenv )`` to your list of
   plugins
...
1. Add ``antibody bundle luismayta/zsh-pyenv`` to your
   ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
   run ``antibody bundle luismayta/zsh-pyenv`` in a
   running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-pyenv.svg
   :target: https://travis-ci.org/luismayta/zsh-pyenv
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-pyenv.svg
   :target: https://github.com/luismayta/zsh-pyenv/issues
...
.. |beacon| image:: https://ga-beacon.appspot.com/UA-65019326-1/github.com/luismayta/zsh-pyenv/readme
