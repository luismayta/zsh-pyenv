...
To contribute to zsh-pyenv project on [GitHub](https://github.com/luismayta/zsh-pyenv), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/zsh-pyenv/pulls).
...
To follow the instructions in this guide and start contributing to zsh-pyenv project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/zsh-pyenv.git
```

Now your **upstream** points to **luismayta/zsh-pyenv**.
...
git fetch upstream # assuming upstream is luismayta/zsh-pyenv
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/zsh-pyenv/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
